...
exports.createCommunityUpdatesMessage = async (req, res) => {
  ...
  try {
    ...
    const DepartmentGroupId = mongoose.Types.ObjectId(LocationData._id.$oid);
    console.log("Department Group ID:", DepartmentGroupId);
    
    const DepartmentTypeId = mongoose.Types.ObjectId(DepartmentGroup._id.$oid);
    console.log("Department Type ID:", DepartmentTypeId);

    const EmployeeRoleId = mongoose.Types.ObjectId(DepartmentType._id.$oid);
    console.log("Employee Role ID:", EmployeeRoleId);

    const EmployeeNameId = mongoose.Types.ObjectId(EmployeeRoles._id.$oid);
    console.log("Employee Role ID:", EmployeeNameId);
